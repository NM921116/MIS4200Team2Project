...
namespace MIS4200Team2Project.Models
{
    ...
    {
       public Guid employeeRecId { get; set; }
      ...
      //  public Guid profileID { get; set; } //recognizerId
        ...
        [Display(Name = "Why is this person receiving the award?")]
        [Required(ErrorMessage = "Please enter why this person is receiving the award.")]
